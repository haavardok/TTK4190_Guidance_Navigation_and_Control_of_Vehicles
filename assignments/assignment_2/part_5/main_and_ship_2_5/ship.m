...
Im = 1E6;               % inertia of the rotating parts including the propeller and added inertia of the water (kgm^2)
Tm = 10;                % time constant of transfer function H(s) from Fossen (9.35)
...
Qd = rho * Dia^5 * KQ * abs(n_c) * n_c;      % desired propeller moment (Nm)
